...
- deterministic backend responses when no AI gateway key is configured
- AI gateway use through backend action when `AI_GATEWAY_API_KEY` or `LOVABLE_API_KEY` is present
