      ...
      <div style={{ opacity }} className="w-full max-w-[1400px] grid lg:grid-cols-2 gap-24 items-center">
        ...
        <div className="flex flex-col gap-10 relative z-10">
          ...
          >
            <div className="flex items-center gap-4">
              <span className="text-emerald-500 font-bold font-mono text-[10px] uppercase tracking-[0.5em]">03 // Intelligent Insights</span>
            </div>
            ...
            <p className="max-w-lg text-lg text-zinc-500 leading-relaxed font-medium">
              Understand your workforce rhythm. Clean, actionable data visualizes team availability and helps prevent burnout before it happens.
            </p>
          </motion.div>
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <img 
              src="./images/generated-1773781143023.png" 
          ...
          {/* Floating Accent */}
          <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-emerald-500/5 blur-[80px] rounded-full -z-10" />
        </div>
