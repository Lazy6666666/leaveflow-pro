      ...
      <div style={{ opacity }} className="w-full max-w-[1400px] grid lg:grid-cols-2 gap-24 items-center">
        ...
        <div className="relative order-2 lg:order-1">
          ...
          >
            ...
            <img 
              src="./images/generated-1773781166083.png" 
        ...
        <div className="flex flex-col gap-10 relative z-10 order-1 lg:order-2">
          ...
          >
            <div className="flex items-center gap-4">
              <span className="text-emerald-500 font-bold font-mono text-[10px] uppercase tracking-[0.5em]">04 // Culture & Flow</span>
            </div>
            ...
            <p className="max-w-lg text-lg text-zinc-500 leading-relaxed font-medium">
              Where presence and balance meet in perfect synchrony. Elevate your culture's flow. This is the new standard of modern team life.
            </p>
          </motion.div>
        </div>
