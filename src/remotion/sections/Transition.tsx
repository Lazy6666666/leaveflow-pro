      ...
      <div style={{ opacity }} className="w-full max-w-[1400px] grid lg:grid-cols-2 gap-24 items-center">
        ...
        <div className="flex flex-col gap-10 relative z-10">
          ...
          >
            <div className="flex items-center gap-4">
              <span className="text-emerald-500 font-bold font-mono text-[10px] uppercase tracking-[0.5em]">01 // Effortless Tracking</span>
            </div>
            ...
            <p className="max-w-lg text-lg text-zinc-500 leading-relaxed font-medium">
              Time is your most valuable asset. Track attendance with invisible precision, letting your team focus on what truly matters.
            </p>
          </motion.div>
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <img 
              src="./images/generated-1773781127082.png" 
