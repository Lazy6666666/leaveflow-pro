    ...
    <div className="mx-auto max-w-6xl space-y-8">
      <div className="space-y-2">
        ...
        <h1 className="text-3xl font-serif font-semibold tracking-tight text-foreground flex items-center gap-2">
          <Wallet className="h-6 w-6 text-foreground" /> Leave Balances
        </h1>
        <p className="mt-1 text-sm text-muted-foreground">View and adjust employee leave balances.</p>
      </div>
      ...
      <Dialog open={adjustDialog} onOpenChange={setAdjustDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Set the updated leave balance in days for the selected leave type.
            </DialogDescription>
          </DialogHeader>
