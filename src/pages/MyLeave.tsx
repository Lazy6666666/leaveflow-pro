  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Your leave balances for {currentYear}</p>
      </div>
          ...
          return (
            <Card key={b.leave_type_id}>
              <CardHeader>
                ...
                <CardTitle className="text-3xl">{b.balance} <span className="text-lg text-muted-foreground font-normal">/ {total} days</span></CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                {b.leave_types?.carry_forward_limit ? (
                  <p className="text-xs text-muted-foreground">Up to {b.leave_types.carry_forward_limit} days can be carried forward</p>
                ) : null}
              </CardContent>
            </Card>
          );
